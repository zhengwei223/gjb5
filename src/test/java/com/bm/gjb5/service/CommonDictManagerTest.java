...
public class CommonDictManagerTest extends BaseManagerTestCase{

	private CommonDictManager manager;
	...
	public static CommonDict newCommonDict() {
		CommonDict obj = new CommonDict();
		
	  	obj.setTableName(new java.lang.String("1"));
	  	obj.setFieldName(new java.lang.String("1"));
	  	obj.setFieldValue(new Integer("1"));
