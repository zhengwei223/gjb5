...
public class SysDisasterPredicateManagerTest extends BaseManagerTestCase{

	private SysDisasterPredicateManager manager;
	...
	public void crud() {
		...
		SysDisasterPredicate obj = newSysDisasterPredicate();
		manager.save(obj);
	...
	public static SysDisasterPredicate newSysDisasterPredicate() {
		SysDisasterPredicate obj = new SysDisasterPredicate();
		
	  	obj.setName(new java.lang.String("1"));
	  	obj.setDescp(new java.lang.String("1"));
	  	obj.setClassifyId(new java.lang.String("1"));
		return obj;
	}
}
