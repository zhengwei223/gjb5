...
public class RightsRoleDaoTest extends BaseDaoTestCase{
	
	private RightsRoleDao dao;
	...
	public void findPage() {
		...
		RightsRoleQuery query = newRightsRoleQuery();
	...
	public static RightsRoleQuery newRightsRoleQuery() {
		RightsRoleQuery query = new RightsRoleQuery();
