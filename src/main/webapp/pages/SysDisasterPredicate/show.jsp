...
<rapid:override name="head">
	<title><%=SysDisasterPredicate.TABLE_ALIAS%>信息</title>
</rapid:override>

<rapid:override name="content">
	<s:form action="/pages/SysDisasterPredicate/list.do" method="get" theme="simple">
		<a class="easyui-linkbutton" data-options="plain:true" onclick="window.location='${ctx}/pages/SysDisasterPredicate/list.do'" >返回列表</a>
