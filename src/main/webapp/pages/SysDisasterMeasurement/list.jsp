...
<rapid:override name="content">
	...
	<div class="queryPanel">
		...
		<div class="handleControl">
			...
			<a href="javascript:;" class="easyui-linkbutton" iconCls="icon-add" onclick="getReferenceForm(this).action='${ctx}/pages/SysDisasterMeasurement/create.do';getReferenceForm(this).submit();" >新增</a>
			</shiro:hasPermission>
			<shiro:hasPermission name="SysDisasterMeasurement:delete">
			<a href="javascript:;" class="easyui-linkbutton" iconCls="icon-remove" onclick="batchDelete('${ctx}/pages/SysDisasterMeasurement/delete.do','items',document.forms.queryForm);" >删除</a>
			</shiro:hasPermission>
		</div>
	</div>
